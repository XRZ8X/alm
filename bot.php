		...
		if($update != null){
          ...
          $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendMessage([
                  'chat_id'=>$chatId,
                  'text'=>"• اهلن بك في اداة هنتر 🔥 لصيد متاحات انستقرام بكل السهوله 😎🤘
~ @X_Q_9 🍂",
		       ...
		       'chat_id'=>$chatId,
                ...
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'HUNTER 🧑🏻‍💻','url'=>'t.me/X_Q_9'],['text'=>'𝐌𝐘 𝐁𝐎𝐓𝐒 🔊','url'=>'t.me/A_h_mpbot']]
                      ]
                  ])
               ]);
           } if($text == '- عربي 👁'){
		       ...
		       'chat_id'=>$chatId,
                ...
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'مطور البوت 👨🏻‍💻','url'=>'t.me/X_Q_9'],['text'=>'قناة البوت 🔊','url'=>'t.me/A_H_M_E_D_0_1_1']]
                      ]
                  ])
               ]);
